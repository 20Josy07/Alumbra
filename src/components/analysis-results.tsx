...
const getRiskBadgeVariant = (
  ...
  if (assessment.includes('high') || assessment.includes('critical')) {
      ...
      <Card className="bg-card/50">
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground">
            This assessment is generated by AI and provides a high-level overview of potential risks in the conversation.
          </p>
        </CardContent>
      </Card>
